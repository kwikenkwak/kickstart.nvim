...
local ensure_installed = { 'ts_ls', 'graphql', 'clangd', 'pyright', 'tailwindcss', 'eslint', 'jsonls', 'yamlls', 'verible', 'lua_ls' }
local ensure_installed_tools = { 'ts_ls', 'graphql', 'clangd', 'pyright', 'tailwindcss', 'eslint', 'jsonls', 'yamlls', 'verible', 'lua_ls' }
